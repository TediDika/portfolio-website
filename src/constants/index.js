...
export const projects = [
  {
    title: "Skyllful Assignments Dashboard",
    description: `Led a team of 5 in an agile full-stack development project sponsored by Skyllful™️,
  ...
  {
    title: "CPU and Memory Simulator",
    description: `Created a simulated computer system with CPU and Memory processes, using Java to
